...
#Generate export and then create an Excel report from it
...
^We don't... Use Full, Lite, or Default unless you need more specific scoping (which is maybe a good idea, 'Lite' is pretty extensive)
